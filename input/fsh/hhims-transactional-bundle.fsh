Instance: HHIMS-Transactional-Bundle
InstanceOf: Bundle
Usage: #example
Title: "HHIMS FULL Transactional Bundle"
...
* entry[+].fullUrl = "MedicationAdministration/InjectionsExample"
...
* entry[=].request.method = #PUT
* entry[=].request.url = "ImagingStudy/ImagingExample"