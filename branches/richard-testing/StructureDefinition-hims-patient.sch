...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:identifier">
      ...
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/sri-lanka/StructureDefinition/multiple-values-for-patient-identifier']) &gt;= 1">extension with URL = 'http://openhie.org/fhir/sri-lanka/StructureDefinition/multiple-values-for-patient-identifier': minimum cardinality of 'extension' is 1</sch:assert>
